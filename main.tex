...
\item $\neg(A \lor B) \vdash (\neg A) \land (\neg B)$ \newline
	...
	{\small
	 \begin{mathpar}
	 \inferrule*[Right={$\landi$}]{\inferrule*[Right={$(\neg{}i) 1$}]{\inferrule*[Right={$(\neg{}e)$}]{\neg{}(A \lor B) \\ \inferrule*[Right={$(\lori)$}]{[A]^1}{A \lor B}}{\bot}}{\neg{} A} \\ \inferrule*[Right={$(\neg{}i) 2$}]{\inferrule*[Right={$(\neg{}e$)}]{\neg{}(A \lor B) \\ \inferrule*[Right={$\lori$}]{[B]^2}{A \lor B}}{\bot}}{\neg{} B}}{\neg{}A \land \neg{}B}
	 \end{mathpar}
	}
...
\item $\neg(A \land B) \vdash (\neg A) \lor (\neg B)$ \newline
  ...
  {\small
  \begin{mathpar}
  \inferrule*[Right={$\lori$}]{\inferrule*[Right={$lte$}]{LTE}{B \land \neg{}B}   \\   \inferrule*[Right={$\lori$}]{\inferrule*[Right={$(\neg{} i)1$}]{\inferrule*[Right={$(\neg{}e)$}]{\neg{}(A \land B) \\ \inferrule*[Right={$(\landi)$}]{[A]^1 \\ [B]^2}{A \land B}}{\bot}}{\neg{}A}}{\neg{}A \lor \neg{}B}  \\   \inferrule*[Right={$\lori$}]{\inferrule*[Right={$(\neg{} i)2$}]{\inferrule*[Right={$(\neg{}e)$}]{[B]^2 \\ [\neg{}B]^3}{\bot}}{\neg{}B}}{\neg{}B \lor \neg{}B} }{\neg{}A \lor \neg{}B}
  \end{mathpar}
  }
...
\item $\neg\neg A \vdash A$ \newline
	...
	{\small
	\begin{mathpar}
	\inferrule*[Right={$pbc,1$}]{\inferrule*[Right={$\neg{}e$}]{A \\ [\neg{}A]^1}{\bot}}{A}
	\end{mathpar}
	}
	}
...
\item $\bot \vdash A$
    ...
    {\small
    \begin{mathpar}
    \inferrule*[Right={$pbc,1$}]{ \inferrule*[Right={$\lande$}]{ \inferrule*[Right={$\landi$}]{\bot \\ [\neg{}A]^1}{\bot \land \neg{}A}}{\bot}}{A}
    \end{mathpar}
    }
...
\item $\vdash ((A \to B) \to A) \to A$ 
	...
	{\small
	\begin{mathpar}
	     \inferrule*[Right={$(\to i)$}]{ \inferrule*[Right={$(\to i)$}]{ \inferrule*[Right={$(\to i)$}]{ \inferrule*[Right={$(mp)$}]{[A \to B]^1 \\ [A]^2}{B} \\  \inferrule*[Right={$(mp)$}]{[A \to B]^1 \\ [A]^3}{A}}{B \to A}}{A \to (B \to A)}}{A \to (A \to (B \to A)}
	\end{mathpar}
	}
...
\item $\vdash A \lor (\neg A)$
    ...
    {\small
    \begin{mathpar}
    \inferrule*[Right={$(pbc),2$}]{\inferrule*[Right={$(\neg{}e)$}]{\neg{}[A \lor \neg{} A]^2 \\   \inferrule*[Right={$\lori$}]{  \inferrule*[Right={$(\neg{}i,1)$}]{  \inferrule*[Right={$(\neg{}e)$}]{\neg{}[A \lor \neg{} A]^2 \\   \inferrule*[Right={$\lori$}]{[A]^1}{A \lor \neg{}A} }{\bot}}{\neg{}A}}{A \lor \neg{} A}}{\bot}}{A \lor \neg{}A}
    \end{mathpar}
    }
    }
\end{enumerate}
